...
<html lang="en">
    <head>
        ...
        <title>GIS | <?php echo $judul; ?></title>
    ...
    <body>
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="">Keliling <b><color>Jakarta</color></b></a>
            <!-- Sidebar Toggle-->
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                                ...
                                <div class="sb-sidenav-menu-heading">Non Database</div>  

                                    <a class="nav-link" href="<?php echo base_url('Home/viewMap'); ?>">
                            ...
                            <a class="nav-link" href="<?php echo base_url('Home/baseMap'); ?>">
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Jelajah Jakarta 2026</div>
                            <div>
